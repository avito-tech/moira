...
func main() {
	...
	defaultRateLimit := cmd.NewDefaultLoggerRateLimit()
	if err = logging.Init(logging.ComponentCli, config.Rsyslog.GetSettings(), defaultRateLimit.GetSettings()); err != nil {
