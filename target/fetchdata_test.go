...
func TestFetchData(t *testing.T) {
	...
	Convey("Test no metrics", t, func() {
		...
		expected := &et.MetricData{FetchResponse: fetchResponse}
		So(metricData, ShouldResemble, []*et.MetricData{expected})
	...
	Convey("Test multiple metrics", t, func() {
		...
		So(metricData, ShouldResemble, []*et.MetricData{&expected, &expected2})
